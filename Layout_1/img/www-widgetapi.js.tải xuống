...
;function Ab(){return H("Firefox")||H("FxiOS")}
function Bb(){return(H("Chrome")||H("CriOS"))&&!H("Edge")}
;var Cb={};function Db(a,b,c){this.h=c===Cb?a:"";this.i=b;this.S=this.na=!0}
Db.prototype.ma=function(){return this.i};
Db.prototype.R=function(){return this.h.toString()};
Db.prototype.toString=function(){return this.h.toString()};
function Eb(a,b){if(void 0===eb){var c=null;var d=z.trustedTypes;if(d&&d.createPolicy){try{c=d.createPolicy("goog#html",{createHTML:Oa,createScript:Oa,createScriptURL:Oa})}catch(e){z.console&&z.console.error(e.message)}eb=c}else eb=c}a=(c=eb)?c.createHTML(a):a;return new Db(a,b,Cb)}
...
var Lb=/#|$/;function Mb(a,b){var c=a.search(Lb);a:{var d=0;for(var e=b.length;0<=(d=a.indexOf(b,d))&&d<c;){var f=a.charCodeAt(d-1);if(38==f||63==f)if(f=a.charCodeAt(d+e),!f||61==f||38==f||35==f)break a;d+=e+1}d=-1}if(0>d)return null;e=a.indexOf("&",d);if(0>e||e>c)e=c;d+=b.length+1;return decodeURIComponent(a.substr(d,e-d).replace(/\+/g," "))}
...
;function Nb(){return H("iPhone")&&!H("iPod")&&!H("iPad")}
;function Ob(a){Ob[" "](a);return a}
Ob[" "]=Fa;var Pb=H("Opera"),Qb=H("Trident")||H("MSIE"),Rb=H("Edge"),Sb=H("Gecko")&&!(-1!=xb.toLowerCase().indexOf("webkit")&&!H("Edge"))&&!(H("Trident")||H("MSIE"))&&!H("Edge"),Tb=-1!=xb.toLowerCase().indexOf("webkit")&&!H("Edge");function Ub(){var a=z.document;return a?a.documentMode:void 0}
var Vb;a:{var Wb="",Xb=function(){var a=xb;if(Sb)return/rv:([^\);]+)(\)|;)/.exec(a);if(Rb)return/Edge\/([\d\.]+)/.exec(a);if(Qb)return/\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a);if(Tb)return/WebKit\/(\S+)/.exec(a);if(Pb)return/(?:Version)[ \/]?(\S+)/.exec(a)}();
Xb&&(Wb=Xb?Xb[1]:"");if(Qb){var Yb=Ub();if(null!=Yb&&Yb>parseFloat(Wb)){Vb=String(Yb);break a}}Vb=Wb}var Zb=Vb,$b;if(z.document&&Qb){var ac=Ub();$b=ac?ac:parseInt(Zb,10)||void 0}else $b=void 0;var bc=$b;Ab();var cc=Nb()||H("iPod"),dc=H("iPad");!H("Android")||Bb()||Ab();Bb();var ec=H("Safari")&&!(Bb()||H("Coast")||H("Opera")||H("Edge")||H("Edg/")||H("OPR")||Ab()||H("Silk")||H("Android"))&&!(Nb()||H("iPad")||H("iPod"));var fc={},gc=null;var hc={ib:{value:!0,configurable:!0}};var ic=Object,jc=ic.freeze,kc=[];Array.isArray(kc)&&!Object.isFrozen(kc)&&Object.defineProperties(kc,hc);jc.call(ic,kc);var J=window;hb("csi.gstatic.com");hb("googleads.g.doubleclick.net");hb("pagead2.googlesyndication.com");hb("partner.googleadservices.com");hb("pubads.g.doubleclick.net");hb("securepubads.g.doubleclick.net");hb("tpc.googlesyndication.com");function lc(a,b){this.width=a;this.height=b}
...
;function ud(a,b){this.type=a;this.h=this.target=b;this.defaultPrevented=this.j=!1}
ud.prototype.stopPropagation=function(){this.j=!0};
ud.prototype.preventDefault=function(){this.defaultPrevented=!0};var vd=function(){if(!z.addEventListener||!Object.defineProperty)return!1;var a=!1,b=Object.defineProperty({},"passive",{get:function(){a=!0}});
try{z.addEventListener("test",Fa,b),z.removeEventListener("test",Fa,b)}catch(c){}return a}();function wd(a,b){ud.call(this,a?a.type:"");this.relatedTarget=this.h=this.target=null;this.button=this.screenY=this.screenX=this.clientY=this.clientX=0;this.key="";this.charCode=this.keyCode=0;this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1;this.state=null;this.pointerId=0;this.pointerType="";this.i=null;a&&this.init(a,b)}
F(wd,ud);var xd={2:"touch",3:"pen",4:"mouse"};
wd.prototype.init=function(a,b){var c=this.type=a.type,d=a.changedTouches&&a.changedTouches.length?a.changedTouches[0]:null;this.target=a.target||a.srcElement;this.h=b;if(b=a.relatedTarget){if(Sb){a:{try{Ob(b.nodeName);var e=!0;break a}catch(f){}e=!1}e||(b=null)}}else"mouseover"==c?b=a.fromElement:"mouseout"==c&&(b=a.toElement);this.relatedTarget=b;d?(this.clientX=void 0!==d.clientX?d.clientX:d.pageX,this.clientY=void 0!==d.clientY?d.clientY:d.pageY,this.screenX=d.screenX||0,this.screenY=d.screenY||
...
function Td(a,b){var c=a.s;if(c){var d=[];for(var e=1;c;c=c.s)d.push(c),++e}a=a.ca;c=b.type||b;"string"===typeof b?b=new ud(b,a):b instanceof ud?b.target=b.target||a:(e=b,b=new ud(c,a),db(b,e));e=!0;if(d)for(var f=d.length-1;!b.j&&0<=f;f--){var g=b.h=d[f];e=Ud(g,c,!0,b)&&e}b.j||(g=b.h=a,e=Ud(g,c,!0,b)&&e,b.j||(e=Ud(g,c,!1,b)&&e));if(d)for(f=0;!b.j&&f<d.length;f++)g=b.h=d[f],e=Ud(g,c,!1,b)&&e}
...
function df(a,b,c){var d=a.split("#",2);a=d[0];d=1<d.length?"#"+d[1]:"";var e=a.split("?",2);a=e[0];e=cf(e[1]||"");for(var f in b)!c&&null!==e&&f in e||(e[f]=b[f]);b=a;a=Kb(e);a?(c=b.indexOf("#"),0>c&&(c=b.length),f=b.indexOf("?"),0>f||f>c?(f=c,e=""):e=b.substring(f+1,c),b=[b.substr(0,f),e,b.substr(c)],c=b[1],b[1]=a?c?c+"&"+a:a:c,a=b[0]+(b[1]?"?"+b[1]:"")+b[2]):a=b;return a+d}
function ef(a){if(!b)var b=window.location.href;var c=a.match(Fb)[1]||null,d=Hb(a);c&&d?(a=a.match(Fb),b=b.match(Fb),a=a[3]==b[3]&&a[1]==b[1]&&a[4]==b[4]):a=d?Hb(b)==d&&(Number(b.match(Fb)[4]||null)||null)==(Number(a.match(Fb)[4]||null)||null):!0;return a}
...
function zf(a,b){var c=N("XSRF_FIELD_NAME",void 0),d=N("XSRF_TOKEN",void 0),e=b.postBody||"",f=b.postParams,g=N("XSRF_FIELD_NAME",void 0),h;b.headers&&(h=b.headers["Content-Type"]);b.excludeXsrf||Hb(a)&&!b.withCredentials&&Hb(a)!=document.location.hostname||"POST"!=b.method||h&&"application/x-www-form-urlencoded"!=h||b.postParams&&b.postParams[g]||(f||(f={}),f[c]=d);f&&"string"===typeof e&&(e=cf(e),db(e,f),e=b.postBodyFormat&&"JSON"==b.postBodyFormat?JSON.stringify(e):Kb(e));if(!(a=e)&&(a=f)){a:{for(var k in f){f=
...
return e}
function Ef(a){if(C(a))for(var b in a){var c;(c="html_content"==b)||(c=b.length-5,c=0<=c&&b.indexOf("_html",c)==c);if(c){c=b;hb("HTML that is escaped and sanitized server-side and passed through yt.net.ajax");var d=Eb(a[b],null);a[c]=d}else Ef(a[b])}}
...
return k}
;var Ff=cc||dc;function Gf(a){var b=xb;return b?0<=b.toLowerCase().indexOf(a):!1}
;var Hf={},If=0;
function Jf(a,b,c,d,e){e=void 0===e?"":e;if(a)if(c&&!Gf("cobalt"))a&&(a instanceof rb||(a="object"==typeof a&&a.S?a.R():String(a),vb.test(a)?a=new rb(a,sb):(a=String(a),a=a.replace(/(%0A|%0D)/g,""),a=(b=a.match(ub))&&tb.test(b[1])?new rb(a,sb):null)),a=a||wb,a instanceof rb&&a.constructor===rb?a=a.h:(Ga(a),a="type_error:SafeUrl"),"about:invalid#zClosurez"===a||a.startsWith("data")?a="":(a instanceof Db||(b="object"==typeof a,c=null,b&&a.na&&(c=a.ma()),a=Eb(jb(b&&a.S?a.R():String(a)),c)),a instanceof
Db&&a.constructor===Db?a=a.h:(Ga(a),a="type_error:SafeHtml"),a=encodeURIComponent(String(Vd(a.toString())))),/^[\s\xa0]*$/.test(a)||(a=oc("IFRAME",{src:'javascript:"<body><img src=\\""+'+a+'+"\\"></body>"',style:"display:none"}),(9==a.nodeType?a:a.ownerDocument||a.document).body.appendChild(a)));else if(e)Af(a,b,"POST",e,d);else if(N("USE_NET_AJAX_FOR_PING_TRANSPORT",!1)||d)Af(a,b,"GET","",d);else{b:{try{var f=new Qa({url:a});if(f.j&&f.i||f.l){var g=Gb(a.match(Fb)[5]||null);var h=!(!g||!g.endsWith("/aclk")||
"1"!==Mb(a,"ri"));break b}}catch(k){}h=!1}h?Kf(a)?(b&&b(),c=!0):c=!1:c=!1;c||Lf(a,b)}}
...
function cg(a,b){if("log_event"===a.endpoint){var c="";a.X?c="visitorOnlyApprovedKey":a.H&&(bg[a.H.token]=dg(a.H),c=a.H.token);var d=ag.get(c)||[];ag.set(c,d);d.push(a.payload);b&&(Wf=new b);a=gf("tvhtml5_logging_max_batch")||gf("web_logging_max_batch")||100;b=R();d.length>=a?eg({writeThenSend:!0},Q("flush_only_full_queue")?c:void 0):10<=b-Zf&&(fg(),Zf=b)}}
...
function eg(a,b){a=void 0===a?{}:a;new Wd(function(c){window.clearTimeout(Xf);window.clearTimeout(Yf);Yf=0;if(Wf&&Wf.isReady())if(void 0!==b){var d=new Map,e=ag.get(b)||[];d.set(b,e);hg(d,c,a);ag.delete(b)}else hg(ag,c,a),ag.clear();else fg(),c()})}
...
function tg(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||N("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.fb||N("AUTHORIZATION"))||(a?b="Bearer "+B("gapi.auth.getToken")().eb:b=Ic([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=N("SESSION_INDEX",0),Q("pageid_as_header_web")&&(d["X-Goog-PageId"]=N("DELEGATED_SESSION_ID")));return d}
;function ug(a){a=Object.assign({},a);delete a.Authorization;var b=Ic();if(b){var c=new bd;c.update(N("INNERTUBE_API_KEY",void 0));c.update(b);b=c.digest();c=3;Ha(b);void 0===c&&(c=0);if(!gc){gc={};for(var d="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".split(""),e=["+/=","+/","-_=","-_.","-_"],f=0;5>f;f++){var g=d.concat(e[f].split(""));fc[f]=g;for(var h=0;h<g.length;h++){var k=g[h];void 0===gc[k]&&(gc[k]=h)}}}c=fc[c];d=Array(Math.floor(b.length/3));e=c[64]||"";for(f=g=0;g<b.length-
...
oa(V,Jg);function Qg(a){V.call(this,"MISSING_OBJECT_STORE",{Na:a},Ng.MISSING_OBJECT_STORE);Object.setPrototypeOf(this,Qg.prototype)}
...
function Tg(a,b,c,d){b=Mg(b);var e=a instanceof Error?a:Error("Unexpected error: "+a);if(e instanceof V)return e;if("QuotaExceededError"===e.name)return new V("QUOTA_EXCEEDED",{objectStoreNames:c,dbName:b});if(ec&&"UnknownError"===e.name)return new V("QUOTA_MAYBE_EXCEEDED",{objectStoreNames:c,dbName:b});if(e instanceof Rg)return new V("MISSING_INDEX",{dbName:b,dbVersion:d,objectStore:e.objectStore,index:e.index});if("InvalidStateError"===e.name&&Sg.some(function(f){return e.message.includes(f)}))return new V("EXECUTE_TRANSACTION_ON_CLOSED_DB",
{objectStoreNames:c,
...
closed:b,Qa:b,upgrade:this.options.upgrade};return this.h=d=a()};var xh=new vh("YtIdbMeta",{ga:{databases:{ia:1}},upgrade:function(a,b){b(1)&&a.h.createObjectStore("databases",{keyPath:"actualName"})}});
...
n.Oa=function(a){this.l=!0;if(void 0===a?0:a)this.B||bi(this)};
...
Y.prototype.sendNetworkCheckRequest=Y.prototype.L;Y.prototype.listen=Y.prototype.Z;Y.prototype.enableErrorFlushing=Y.prototype.Da;Y.prototype.getWindowStatus=Y.prototype.da;Y.prototype.monitorNetworkStatusChange=Y.prototype.Oa;Y.prototype.isNetworkAvailable=Y.prototype.J;Y.getInstance=ai;function ci(a){a=void 0===a?{}:a;L.call(this);var b=this;this.l=this.u=0;this.i=ai();var c=B("yt.networkStatusManager.instance.monitorNetworkStatusChange").bind(this.i);c&&c(a.Ea);a.Ma&&(c=B("yt.networkStatusManager.instance.enableErrorFlushing").bind(this.i))&&c();if(c=B("yt.networkStatusManager.instance.listen").bind(this.i))a.ba?(this.ba=a.ba,c("ytnetworkstatus-online",function(){di(b,"publicytnetworkstatus-online")}),c("ytnetworkstatus-offline",function(){di(b,"publicytnetworkstatus-offline")})):
...
function mi(a){return I(this,function c(){var d,e,f;return y(c,function(g){switch(g.h){case 1:d=ni();if(!d)throw e=Ug("immediateSend"),e;if(void 0===a.id){g.v(2);break}return w(g,Sh(a.id),3);case 3:(f=g.i)?a=f:Me(Error("The request cannot be found in the database."));case 2:var h=a.timestamp;if(!(2592E6<=R()-h)){g.v(4);break}Me(Error("Networkless Logging: Stored logs request expired age limit"));if(void 0===a.id){g.v(5);break}return w(g,Uh(a.id),5);case 5:return g.return();case 4:a.skipRetry||(a=
qi(a));h=a;var k,l;if(null===(l=null===(k=null===h||void 0===h?void 0:h.options)||void 0===k?void 0:k.postParams)||void 0===l?0:l.requestTimeMs)h.options.postParams.requestTimeMs=Math.round(R());a=h;if(!a){g.v(0);break}if(!a.skipRetry||void 0===a.id){g.v(8);break}return w(g,Uh(a.id),8);case 8:li(a.url,a.options,!!a.skipRetry),g.h=0}})})}
...
function li(a,b,c){if(Q("networkless_with_beacon")){var d=["method","postBody"];if(Object.keys(b).length>d.length)c=!0;else{c=0;d=u(d);for(var e=d.next();!e.done;e=d.next())b.hasOwnProperty(e.value)&&c++;c=Object.keys(b).length!==c}c?xf(a,b):Mf(a,void 0,b.postBody)}else c&&0===Object.keys(b).length?Jf(a):xf(a,b)}
function ki(){return B("ytNetworklessLoggingInitializationOptions")?hi.isNwlInitialized:!1}
function ni(){return B("ytNetworklessLoggingInitializationOptions")?hi.databaseToken:void 0}
...
;function Ci(a,b,c,d){if(a)if(Array.isArray(a)){var e=d;for(d=0;d<a.length&&!(a[d]&&(e+=Di(d,a[d],b,c),500<e));d++);d=e}else if("object"===typeof a)for(e in a){if(a[e]){var f=a[e];var g=b;var h=c;g="string"!==typeof f||"clickTrackingParams"!==e&&"trackingParams"!==e?0:(f=Ai(atob(f.replace(/-/g,"+").replace(/_/g,"/"))))?Di(e+".ve",f,g,h):0;d+=g;d+=Di(e,a[e],b,c);if(500<d)break}}else c[b]=Ei(a),d+=c[b].length;else c[b]=Ei(a),d+=c[b].length;return d}
...
;function Ti(a){this.h=a||{};a=[this.h,window.YTConfig||{}];for(var b=0;b<a.length;b++)a[b].host&&(a[b].host=a[b].host.toString().replace("http://","https://"))}
function Z(a,b){a=[a.h,window.YTConfig||{}];for(var c=0;c<a.length;c++){var d=a[c][b];if(void 0!==d)return d}return null}
function Ui(a,b,c){Vi||(Vi={},Ue(window,"message",function(d){a:{if(d.origin===Z(a,"host")){try{var e=JSON.parse(d.data)}catch(f){e=void 0;break a}if(d=Vi[e.id])d.s=!0,d.s&&(G(d.o,d.sendMessage,d),d.o.length=0),d.ha(e)}e=void 0}return e}));
Vi[c]=b}
...
n=Wi.prototype;n.setSize=function(a,b){this.h.width=a.toString();this.h.height=b.toString();return this};
n.za=function(){return this.h};
n.ha=function(a){Xi(this,a.event,a)};
...
n.destroy=function(){this.h&&this.h.id&&(Ni[this.h.id]=null);var a=this.l;a&&"function"==typeof a.dispose&&a.dispose();if(this.m){a=this.h;var b=a.parentNode;b&&b.replaceChild(this.m,a)}else(a=this.h)&&a.parentNode&&a.parentNode.removeChild(a);Vi&&(Vi[this.id]=null);this.i=null;a=this.h;for(var c in $a)$a[c][0]==a&&Se(c);this.m=this.h=null};
...
function Xi(a,b,c){a.l.j||(c={target:a,data:c},a.l.O(b,c),Si(a.u+"."+b,c))}
...
b.toString());var g=a.ka();g.enablejsapi=window.postMessage?1:0;window.location.host&&(g.origin=window.location.protocol+"//"+window.location.host);g.widgetid=a.id;window.location.href&&G(["debugjs","debugcss"],function(h){var k=Mb(window.location.href,h);null!==k&&(g[h]=k)});
window.yt_embedsTokenValue&&(g.embedsTokenValue=encodeURIComponent(window.yt_embedsTokenValue),delete window.yt_embedsTokenValue);c.src=Z(a.i,"host")+("/embed/"+Z(a.i,"videoId"))+"?"+Kb(g);return c}
...
n.setup=function(a,b){var c=document;if(a="string"===typeof a?c.getElementById(a):a)if(c="iframe"===a.tagName.toLowerCase(),b.host||(b.host=c?Ib(a.src):"https://www.youtube.com"),this.i=new Ti(b),c||(b=aj(this,a),this.m=a,(c=a.parentNode)&&c.replaceChild(b,a),a=b),this.h=a,this.h.id||(this.h.id="widget"+Ia(this.h)),Ni[this.h.id]=this,window.postMessage){this.l=new M;bj(this);b=Z(this.i,"events");for(var d in b)b.hasOwnProperty(d)&&this.addEventListener(d,b[d]);for(var e in Pi)Pi.hasOwnProperty(e)&&
Zi(this,e)}};
function Yi(a,b){a.B[b]||(a.B[b]=!0,$i(a,"addEventListener",[b]))}
n.sendMessage=function(a){a.id=this.id;a.channel="widget";a=Vd(a);var b=[Ib(this.h.src||"").replace("http:","https:")];if(this.h.contentWindow)for(var c=0;c<b.length;c++)try{this.h.contentWindow.postMessage(a,b[c])}catch(v){if(v.name&&"SyntaxError"===v.name){if(!(v.message&&0<v.message.indexOf("target origin ''"))){var d=void 0,e=v;d=void 0===d?{}:d;d.name=N("INNERTUBE_CONTEXT_CLIENT_NAME",1);d.version=N("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0);var f=d||{};d="WARNING";d=void 0===d?"ERROR":d;if(e){e.hasOwnProperty("level")&&
e.level&&(d=e.level);if(Q("console_log_js_exceptions")){var g=e,h=[];h.push("Name: "+g.name);h.push("Message: "+g.message);g.hasOwnProperty("params")&&h.push("Error Params: "+JSON.stringify(g.params));g.hasOwnProperty("args")&&h.push("Error args: "+JSON.stringify(g.args));h.push("File name: "+g.fileName);h.push("Stacktrace: "+g.stack);window.console.log(h.join("\n"),g)}if(!(5<=Gi)){g=void 0;var k=f,l=dd(e);f=l.message||"Unknown Error";h=l.name||"UnknownError";var m=l.stack||e.i||"Not available";if(m.startsWith(h+
": "+f)){var q=m.split("\n");q.shift();m=q.join("\n")}q=l.lineNumber||"Not available";l=l.fileName||"Not available";var t=0;if(e.hasOwnProperty("args")&&e.args&&e.args.length)for(g=0;g<e.args.length&&!(t=Ci(e.args[g],"params."+g,k,t),500<=t);g++);else if(e.hasOwnProperty("params")&&e.params){var p=e.params;if("object"===typeof e.params)for(g in p){if(p[g]){var x="params."+g,A=Ei(p[g]);k[x]=A;t+=x.length+A.length;if(500<t)break}}else k.params=Ei(p)}if(Ji.length)for(g=0;g<Ji.length&&!(t=Ci(Ji[g],"params.context."+
g,k,t),500<=t);g++);navigator.vendor&&!k.hasOwnProperty("vendor")&&(k["device.vendor"]=navigator.vendor);g={message:f,name:h,lineNumber:q,fileName:l,stack:m,params:k,sampleWeight:1};f=Number(e.columnNumber);isNaN(f)||(g.lineNumber=g.lineNumber+":"+f);if("IGNORED"===e.level)e=0;else a:{e=yi();f=u(e.K);for(h=f.next();!h.done;h=f.next())if(h=h.value,g.message&&g.message.match(h.jb)){e=h.weight;break a}e=u(e.I);for(f=e.next();!f.done;f=e.next())if(f=f.value,f.Aa(g)){e=f.weight;break a}e=1}g.sampleWeight=
e;e=g;g=u(ti);for(f=g.next();!f.done;f=g.next())if(f=f.value,f.aa[e.name])for(q=u(f.aa[e.name]),h=q.next();!h.done;h=q.next())if(l=h.value,h=e.message.match(l.regexp)){e.params["params.error.original"]=h[0];q=l.groups;l={};for(m=0;m<q.length;m++)l[q[m]]=h[m+1],e.params["params.error."+q[m]]=h[m+1];e.message=f.fa(l);break}e.params||(e.params={});g=yi();e.params["params.errorServiceSignature"]="msg="+g.K.length+"&cb="+g.I.length;e.params["params.serviceWorker"]="false";z.document&&z.document.querySelectorAll&&
(e.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));hb("sample").constructor!==fb&&(e.params["params.fconst"]="true");window.yterr&&"function"===typeof window.yterr&&window.yterr(e);if(0!==e.sampleWeight&&!Fi.has(e.message)){"ERROR"===d?(zi.O("handleError",e),Q("record_app_crashed_web")&&0===Ii&&1===e.sampleWeight&&(Ii++,si("appCrashed",{appCrashType:"APP_CRASH_TYPE_BREAKPAD"})),Hi++):"WARNING"===d&&zi.O("handleWarning",e);if(Q("kevlar_gel_error_routing")){g=
d;l=e;b:{f=u(Ki);for(h=f.next();!h.done;h=f.next())if(Gf(h.value.toLowerCase())){f=!0;break b}f=!1}if(f)f=void 0;else{h={stackTrace:l.stack};l.fileName&&(h.filename=l.fileName);f=l.lineNumber&&l.lineNumber.split?l.lineNumber.split(":"):[];0!==f.length&&(1!==f.length||isNaN(Number(f[0]))?2!==f.length||isNaN(Number(f[0]))||isNaN(Number(f[1]))||(h.lineNumber=Number(f[0]),h.columnNumber=Number(f[1])):h.lineNumber=Number(f[0]));f={level:"ERROR_LEVEL_UNKNOWN",message:l.message,errorClassName:l.name,sampleWeight:l.sampleWeight};
...
value:m}));f={errorMetadata:q,stackTrace:h,logMessage:f}}f&&(si("clientError",f),("ERROR"===g||Q("errors_flush_gel_always_killswitch"))&&eg())}if(!Q("suppress_error_204_logging")){f=e;g=f.params||{};d={urlParams:{a:"logerror",t:"jserror",type:f.name,msg:f.message.substr(0,250),line:f.lineNumber,level:d,"client.name":g.name},postParams:{url:N("PAGE_NAME",window.location.href),file:f.fileName},method:"POST"};g.version&&(d["client.version"]=g.version);if(d.postParams){f.stack&&(d.postParams.stack=f.stack);
f=u(Object.keys(g));for(h=f.next();!h.done;h=f.next())h=h.value,d.postParams["client."+h]=g[h];if(g=N("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(f=u(Object.keys(g)),h=f.next();!h.done;h=f.next())h=h.value,d.postParams[h]=g[h];g=N("SERVER_NAME",void 0);f=N("SERVER_VERSION",void 0);g&&f&&(d.postParams["server.name"]=g,d.postParams["server.version"]=f)}xf(N("ECATCHER_REPORT_HOST","")+"/error_204",d)}try{Fi.add(e.message)}catch(K){}Gi++}}}}}else throw v;}else console&&console.warn&&console.warn("The YouTube player is not attached to the DOM. API calls should be made after the onReady event. See more: https://developers.google.com/youtube/iframe_api_reference#Events")};function cj(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
...
oa(ej,Wi);n=ej.prototype;n.ka=function(){var a=Z(this.i,"playerVars");if(a){var b={},c;for(c in a)b[c]=a[c];a=b}else a={};window!==window.top&&document.referrer&&(a.widget_referrer=document.referrer.substring(0,256));if(c=Z(this.i,"embedConfig")){if(C(c))try{c=JSON.stringify(c)}catch(d){console.error("Invalid embed config JSON",d)}a.embed_config=c}return a};
n.ha=function(a){var b=a.event;a=a.info;switch(b){case "apiInfoDelivery":if(C(a))for(var c in a)a.hasOwnProperty(c)&&(this.F[c]=a[c]);break;case "infoDelivery":fj(this,a);break;case "initialDelivery":C(a)&&(window.clearInterval(this.j),this.playerInfo={},this.F={},gj(this,a.apiInterface),fj(this,a));break;default:Xi(this,b,a)}};
...
function hj(a){if("iframe"!==a.tagName.toLowerCase()){var b=Ri(a,"videoid");b&&(b={videoId:b,width:Ri(a,"width"),height:Ri(a,"height")},new ej(a,b))}}
...
D("YT.scan",Qi);D("YT.subscribe",function(a,b,c){me.subscribe(a,b,c);Pi[a]=!0;for(var d in Ni)Ni.hasOwnProperty(d)&&Zi(Ni[d],a)});
D("YT.unsubscribe",function(a,b,c){le(a,b,c)});
D("YT.Player",ej);Wi.prototype.destroy=Wi.prototype.destroy;Wi.prototype.setSize=Wi.prototype.setSize;Wi.prototype.getIframe=Wi.prototype.za;Wi.prototype.addEventListener=Wi.prototype.addEventListener;ej.prototype.getVideoEmbedCode=ej.prototype.getVideoEmbedCode;ej.prototype.getOptions=ej.prototype.getOptions;ej.prototype.getOption=ej.prototype.getOption;
...
"undefined"!=typeof YTConfig&&YTConfig.parsetags&&"onload"!=YTConfig.parsetags||Qi();var ij=z.onYTReady;ij&&ij();var jj=z.onYouTubeIframeAPIReady;jj&&jj();var kj=z.onYouTubePlayerAPIReady;kj&&kj();}).call(this);
